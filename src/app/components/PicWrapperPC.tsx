...
const PicWrapperPC: React.FC = () => {
  ...
  return (
    <div ref={glideRef} className="glide md:max-w-[600px] lg:max-w-[900px] my-0 mx-auto relative shadow-xl">
      ...
      <div className="glide__arrows absolute bottom-8 right-5 flex gap-2" data-glide-el="controls">
