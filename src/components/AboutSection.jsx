...
const AboutSection = () => {
  const stats = [
    { icon: Code, label: "Projects", value: "50+", color: "text-[#728559]" },
    { icon: Coffee, label: "Coffee Cups", value: "1000+", color: "text-[#8b4513]" },
    { icon: Trophy, label: "Awards", value: "12", color: "text-[#ffd700]" },
    { icon: Users, label: "Happy Clients", value: "25+", color: "text-[#4169e1]" }
  ]
  ...
  const techStack = ["React", "Node.js", "TypeScript", "Python", "AWS", "Docker"]
    ...
    <div className="max-w-6xl mx-auto space-y-8">
          ...
          <div className="relative group">
            ...
            <div className="w-72 h-72 md:w-80 md:h-80 lg:ml-38 rounded-2xl overflow-hidden shadow-xl border-4 border-[#948a75] transform hover:scale-105 transition-all duration-500 bg-white">
              <img
                ...
                alt="John Developer - Frontend Developer"
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-[#12160b]/40 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-end justify-center pb-4">
                <div className="text-[#cec7b5] text-center">
                  ...
                  <p className="text-xs opacity-80">Frontend Specialist</p>
                </div>
              </div>
            </div>
        ...
        <div className="space-y-6 order-2 lg:order-2">
          <div className="text-center lg:text-left space-y-3">
            ...
            <p className="text-[#4d4937] text-base leading-relaxed max-w-xl">
              ...
              I specialize in creating beautiful, efficient, and scalable digital experiences 
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            ...
            <div className="flex items-center gap-3 text-[#4d4937] bg-[#cec7b5]/50 p-3 rounded-lg border border-[#948a75]/30 hover:border-[#728559]/50 transition-all duration-300">
              ...
              <div>
                ...
                <p className="text-sm font-semibold">john@example.com</p>
              </div>
            </div>
            <div className="flex items-center gap-3 text-[#4d4937] bg-[#cec7b5]/50 p-3 rounded-lg border border-[#948a75]/30 hover:border-[#728559]/50 transition-all duration-300">
              <Calendar className="w-4 h-4 text-[#728559]" />
              <div>
                <p className="text-xs text-[#728559] font-medium">Experience</p>
            ...
            <div className="flex items-center gap-3 text-[#4d4937] bg-[#cec7b5]/50 p-3 rounded-lg border border-[#948a75]/30 hover:border-[#728559]/50 transition-all duration-300">
              ...
              <div>
                <p className="text-xs text-[#728559] font-medium">Work Type</p>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        {stats.map((stat, index) => {
          ...
          return (
            <Card key={index} className="text-center border-[#948a75]/30 bg-[#cec7b5]/30 hover:bg-[#a4b292]/30 transition-all duration-300 hover:scale-105">
              <CardContent className="p-4">
                <Icon className={`w-8 h-8 mx-auto mb-2 ${stat.color}`} />
                <div className="text-2xl font-bold text-[#12160b]">{stat.value}</div>
                <div className="text-sm text-[#4d4937] font-medium">{stat.label}</div>
              </CardContent>
            </Card>
          )
        })}
          ...
          <CardContent>
            <div className="grid grid-cols-1 gap-3">
              {highlights.map((highlight, index) => (
                <div key={index} className="flex items-center gap-2 text-[#4d4937] p-2 rounded-lg hover:bg-[#a4b292]/20 transition-colors">
        ...
        <Card className="border-[#948a75]/30 bg-[#cec7b5]/30">
          ...
          <CardContent>
            ...
            <p className="text-sm text-[#4d4937] mt-4 leading-relaxed">
              ...
              forefront of web development. Currently diving deep into AI integration 
